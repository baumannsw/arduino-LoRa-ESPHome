...
LoRaClass::LoRaClass() : _spiSettings(LORA_DEFAULT_SPI_FREQUENCY, MSBFIRST, SPI_MODE0),
                         ...
                         _spi_begin(NULL),
                         _spi_end(NULL),
                         _spi_beginTransaction(NULL),
                         _spi_endTransaction(NULL),
                         _spi_transfer(NULL)
{
...
void LoRaClass::onSPI_begin(void (*callback)())
{
  _spi_begin = callback;
}
void LoRaClass::onSPI_end(void (*callback)())
{
  _spi_end = callback;
}
void LoRaClass::onSPI_beginTransaction(void (*callback)(SPISettings settings))
{
  _spi_beginTransaction = callback;
}
void LoRaClass::onSPI_EndTransaction(void (*callback)())
{
  _spi_endTransaction = callback;
}
void LoRaClass::onSPI_transfer(uint8_t (*callback)(uint8_t))
{
  _spi_transfer = callback;
}
...
uint8_t LoRaClass::singleTransfer(uint8_t address, uint8_t value)
{
  ...
  if (_spi_beginTransaction == nullptr)
  {
